...
GO
PRINT N'Dropping [dbo].[FK_GarageMaxCars_Garages]...';


GO
ALTER TABLE [dbo].[GarageMaxCars] DROP CONSTRAINT [FK_GarageMaxCars_Garages];


GO
PRINT N'Starting rebuilding table [dbo].[GarageMaxCars]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_GarageMaxCars] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[GarageMaxCars])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_GarageMaxCars] ON;
        INSERT INTO [dbo].[tmp_ms_xx_GarageMaxCars] ([Id], [GarageID], [CarPerCrewAdmin], [DayRef])
        SELECT   [Id],
                 [GarageID],
                 [CarPerCrewAdmin],
                 [DayRef]
        FROM     [dbo].[GarageMaxCars]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_GarageMaxCars] OFF;
    END

DROP TABLE [dbo].[GarageMaxCars];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_GarageMaxCars]', N'GarageMaxCars';
